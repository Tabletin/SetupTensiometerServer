...
namespace SetupTensServer
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void RestoreDatabase_Click(object sender, RoutedEventArgs e) {
            const string message = "Warning!!! Restoring database may result in possible data loss. Proceed with caution. ";
            MessageBox.Show(message, "Alert!", MessageBoxButton.OK, MessageBoxImage.Warning);
            RestoreDatabaseWindow restoreDatabaseWindow = new RestoreDatabaseWindow();
            restoreDatabaseWindow.ShowDialog();
        }
